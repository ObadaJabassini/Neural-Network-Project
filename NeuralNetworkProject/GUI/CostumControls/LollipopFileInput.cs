...
public class LollipopFileInput : Control
{
    ...
    Color focusColor = Color.DarkSlateGray;

    Color EnabledFocusedColor = Color.FromArgb(32, 159, 221);
    Color EnabledStringColor = Color.FromArgb(32, 159, 221);
    ...
    public void AddTextBox()
    {
        ...
        LollipopTB.BackColor =Color.FromArgb(255, 51, 51, 51);
        LollipopTB.UseSystemPasswordChar = UseSystemPasswordChar;
